...
// Packages with native bindings that cannot be bundled
...
// The ESM banner ensures CJS-only packages (e.g. express) work inside the ESM bundle
const esmCjsBanner = `import { createRequire as __bannerCrReq } from 'node:module';
