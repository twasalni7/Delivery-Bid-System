      ...
      <div dir="rtl" className="max-w-lg mx-auto space-y-5">
        ...
        <div className="rounded-3xl p-5" style={{ backgroundColor: "var(--surface)", border: "1px solid var(--border-subtle)" }}>
          ...
          <div className="space-y-2">
            <Link href="/client/support?topic=faq" aria-label="الانتقال إلى الأسئلة الشائعة" className="block rounded-2xl px-4 py-3 hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-300" style={{ backgroundColor: "var(--surface-2)" }}>
              <span className="flex items-center justify-between text-sm font-bold" style={{ color: "var(--text-sub)" }}>
                <span>الأسئلة الشائعة</span>
                <span aria-hidden="true">‹</span>
              </span>
            </Link>
            <Link href="/client/support?topic=complaint" aria-label="الانتقال إلى رفع شكوى" className="block rounded-2xl px-4 py-3 hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-300" style={{ backgroundColor: "var(--surface-2)" }}>
              <span className="flex items-center justify-between text-sm font-bold" style={{ color: "var(--text-sub)" }}>
                <span>رفع شكوى</span>
                <span aria-hidden="true">‹</span>
              </span>
