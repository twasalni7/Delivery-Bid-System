...
--
-- إذا كانت قاعدة البيانات موجودة مسبقاً وتحتوي على جدول "المشرفون"
-- (الاسم العربي القديم)، شغّل أولاً ملف rename_admins_table.sql
-- لإعادة تسميته قبل تشغيل هذا الملف.
--
-- ترتيب التنفيذ:
--   1. Enums
